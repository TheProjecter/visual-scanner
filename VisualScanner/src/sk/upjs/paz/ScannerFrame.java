...
class ScannerFrame extends JFrame {
	...
	private void initializeComponents() {
		setIconImage(Toolkit.getDefaultToolkit().getImage(ScannerFrame.class.getResource("/sk/upjs/paz/visualScanner.png")));
		...
		hasNextsPanel.setBorder(new TitledBorder(UIManager.getBorder("TitledBorder.border"), "Results of HasNext___", TitledBorder.LEADING, TitledBorder.TOP, null, null));

		JPanel panel_2 = new JPanel();
		panel_2.setBorder(new TitledBorder(null, "Content to scan", TitledBorder.LEADING, TitledBorder.TOP, null, null));
		GroupLayout gl_contentPane = new GroupLayout(contentPane);
		gl_contentPane.setHorizontalGroup(gl_contentPane.createParallelGroup(Alignment.LEADING).addComponent(hasNextsPanel, GroupLayout.DEFAULT_SIZE, 360, Short.MAX_VALUE).addComponent(panel_2, GroupLayout.DEFAULT_SIZE, 360, Short.MAX_VALUE)
				.addComponent(infoPanel, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE));
		gl_contentPane.setVerticalGroup(gl_contentPane.createParallelGroup(Alignment.LEADING).addGroup(
				gl_contentPane.createSequentialGroup().addComponent(infoPanel, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE).addGap(5).addComponent(hasNextsPanel, GroupLayout.PREFERRED_SIZE, 169, GroupLayout.PREFERRED_SIZE)
						.addPreferredGap(ComponentPlacement.RELATED).addComponent(panel_2, GroupLayout.DEFAULT_SIZE, 242, Short.MAX_VALUE)));
		...
		btnExecute.setIcon(new ImageIcon(ScannerFrame.class.getResource("/sk/upjs/paz/executeIcon.png")));
		...
		highlightButton.setIcon(new ImageIcon(ScannerFrame.class.getResource("/sk/upjs/paz/highlight.png")));
				...
				gl_panel_2
						...
						.addGroup(
								gl_panel_2
										...
										.addComponent(bufferPaneScroller, Alignment.LEADING, GroupLayout.DEFAULT_SIZE, 328, Short.MAX_VALUE)
										.addGroup(
												gl_panel_2.createSequentialGroup().addComponent(lblNewLabel_4).addPreferredGap(ComponentPlacement.RELATED).addComponent(nextTokenLabel).addPreferredGap(ComponentPlacement.RELATED, 82, Short.MAX_VALUE).addComponent(highlightButton)
														.addPreferredGap(ComponentPlacement.RELATED).addComponent(btnSpecialChars))).addContainerGap()));
		gl_panel_2.setVerticalGroup(gl_panel_2.createParallelGroup(Alignment.LEADING).addGroup(
				gl_panel_2.createSequentialGroup().addGap(6).addGroup(gl_panel_2.createParallelGroup(Alignment.BASELINE).addComponent(lblNewLabel_4).addComponent(nextTokenLabel).addComponent(btnSpecialChars).addComponent(highlightButton))
						.addPreferredGap(ComponentPlacement.RELATED).addComponent(bufferPaneScroller, GroupLayout.DEFAULT_SIZE, 169, Short.MAX_VALUE).addContainerGap()));
		...
		addWindowListener(new WindowAdapter() {
			...
			public void windowClosing(WindowEvent e) {
				if (JOptionPane.showConfirmDialog(ScannerFrame.this, "Do you really want to exit this program?", "Confirm Exit", JOptionPane.YES_NO_OPTION) == JOptionPane.YES_OPTION) {
					System.exit(0);
				}
			}
		});
